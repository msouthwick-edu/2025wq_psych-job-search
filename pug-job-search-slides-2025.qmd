...
- Question in RSVP about when YOU should apply. It's a dance. One reason why I pushed for a WQ workshop is spending SQ applying to jobs could be a good use of time. If you get a full-time offer, you can negotiate a start date.
:::
...
# Step 0: What are Your Interests?

## Do an Assessment {.smaller}

- [https://www.imaginephd.com/users/sign-in](https://www.imaginephd.com/users/sign-in)
  - Create Account
  - Interests Assessment
  - ALSO: Resources >> Job Family Resources
- [https://myidp.sciencecareers.org/](https://myidp.sciencecareers.org/)
  - Create Account
  - Interests Assessment
  - Consider Career Fit
...
*Post in chat or unmute and share what job family or positions came up for you?*

::: {.notes}
I will keep track of these and maybe use these as an example in future parts of this workshop.
:::
...
::: {.notes}
refer to reader for examples, idealist is one of them
::: 
...
### Set-Up a Profile
1. Go to linkedin.com: [https://www.linkedin.com/](https://www.linkedin.com/).
...
- If you already have an account, you can refer to the Career Center page on profile tips [here](https://careercenter.ucdavis.edu/job-and-internship-search/finding-positions/linkedin-and-others).*
- During this time, you can develop your profile by:
  - Changing your headline & update your about section
  - Add in relevant experiences to your profile and describe them using bullet points: "ACTION VERB + CONTEXT = RESULTS"

Here is my profile as an example (it's not perfect): [https://www.linkedin.com/in/maia-southwick/](https://www.linkedin.com/in/maia-southwick/)
:::
...
- if someone has an account, drop this link in the chat: https://careercenter.ucdavis.edu/job-and-internship-search/finding-positions/linkedin-and-others for them to work on their profiles during this time.
...
::: {.notes}
Look at reader and go through key terms, and parts of the job board
:::
...
## Completed the Final Step for Today! {.smaller}

- Please fill out this exit survey: [https://tinyurl.com/pug-exit-survey](https://tinyurl.com/pug-exit-survey)
- Open Q&A + Troubleshooting

::: {layout-ncol=2}
![](https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExZng3ODA5eHRudHdxODU4aXhnbnE4NXdsdHc0ZW1nNHhhMGtqZWczMiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/m2Q7FEc0bEr4I/giphy.gif){fig-align="left" width=200% height=200%}

![](exit-survey.png){fig-align="right" width="400" height="400"} 
:::
